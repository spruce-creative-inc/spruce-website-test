...
},{"./utils/matrix.js":"node_modules/gsap/utils/matrix.js"}],"node_modules/gsap/ScrollTrigger.js":[function(require,module,exports) {
"use strict";
...
_gsap.gsap.registerPlugin(_Draggable.default);

_Draggable.default.create('.card-wrap', {
  type: 'scroll'
});
...
var xSet = _gsap.gsap.quickSetter(ball, "x", "px");

var ySet = _gsap.gsap.quickSetter(ball, "y", "px");
...
_gsap.gsap.ticker.add(function () {
  ...
  var dt = 1.0 - Math.pow(1.0 - speed, _gsap.gsap.ticker.deltaRatio());
...
var fancyText = document.querySelector('.fancy-text');

function updateGradientVars(e) {
  var yPercent = Math.ceil(e.y / window.innerHeight * 100);
  var xPercent = Math.ceil(e.x / window.innerWidth * 100);
  fancyText.setAttribute('style', "--pos1: ".concat(100 - xPercent, "% center; --pos2: ").concat((100 - xPercent) / 2, "% ").concat(100 - yPercent, "%;"));
} // function updateGradientVars(e) {
//   const yPercent = Math.ceil((e.y / window.innerHeight) * 100);
//   const xPercent = Math.ceil((e.x / window.innerWidth) * 100);
//   fancyText.setAttribute('style', `--pos1: ${xPercent / 2}% ${yPercent}%; --pos2: ${(100 - xPercent) / 2}% ${(100 - yPercent)}%;`)
// }


window.addEventListener("mousemove", updateGradientVars);
},{"gsap":"node_modules/gsap/index.js","gsap/Draggable":"node_modules/gsap/Draggable.js","gsap/ScrollTrigger":"node_modules/gsap/ScrollTrigger.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
